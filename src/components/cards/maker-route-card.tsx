...
export function MakerRouteCard({ route }: { route: MakerRoute }) {
  ...
  return (
    <div
      className={`group rounded-md border border-border border-t-2 bg-white p-6 transition-all duration-200 hover:-translate-y-1 hover:shadow-[var(--shadow-float)] ${accent.borderTop}`}
    >
      <div
